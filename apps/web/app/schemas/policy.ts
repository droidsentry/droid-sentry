...
const ScreenTimeoutSettingsSchema = z.object({
  screenTimeout: z
    .string()
...
const DisplaySettingsPolicySchema = z.object({
  ...
  screenTimeoutSettings: ScreenTimeoutSettingsSchema,
...
export const policySchema = z
  .object({
    ...
    cameraAccess: cameraAccessSchema,
    ...
    displaySettings: DisplaySettingsPolicySchema,
    ...
    dataRoamingDisabled: z.boolean().default(false),
