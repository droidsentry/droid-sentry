...
import { DataTableColumnHeader } from "@/app/[locale]/(main)/projects/components/table/data-table-column-header";
import { DataTableColumnSortHeader } from "@/app/[locale]/(main)/projects/components/table/data-table-column-sort-header";
import { selectColumn } from "@/app/[locale]/(main)/projects/components/table/select-column";
