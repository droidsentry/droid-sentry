...
interface PasswordResetAlertDialogProps<TData> {
...
export default function PasswordResetAlertDialog<TData>({
  isPasswordResetDialogOpen,
  setIsPasswordResetDialogOpen,
  enterpriseId,
  devices,
  table,
}: PasswordResetAlertDialogProps<TData>) {
  const form = useForm({
    mode: "onChange",
