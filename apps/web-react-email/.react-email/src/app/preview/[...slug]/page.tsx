...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["confirmation"]},{"slug":["recovery"]},{"slug":["components","tailwind-page"]},{"slug":["sample","notion-magic-link"]},{"slug":["sample","plaid-verify-identity"]},{"slug":["sample","stripe-welcome"]},{"slug":["sample","vercel-invite-user"]}]
  );
}